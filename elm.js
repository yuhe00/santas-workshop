...
Elm.Santa.Model.Producer.make = function (_elm) {
   ...
   10,
   $Santa$Model$Product.wood)]))($Santa$Common.Named("Wooden Toy Maker")($Basics.identity({_: {}}))));
   ...
   10,
   $Santa$Model$Product.metal)]))($Santa$Common.Named("Toy Car Factory")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.plastic)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                         ...
                                                                                         ,A2($Santa$Model$Stackable.stack,
                                                                                         5,
                                                                                         $Santa$Model$Product.oil)]))($Santa$Common.Named("Oil Refinery")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.battery)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                         ...
                                                                                         ,A2($Santa$Model$Stackable.stack,
                                                                                         10,
                                                                                         $Santa$Model$Product.oil)]))($Santa$Common.Named("Battery Manufacturer")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.microchip)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                           ...
                                                                                           ,A2($Santa$Model$Stackable.stack,
                                                                                           20,
                                                                                           $Santa$Model$Product.oil)]))($Santa$Common.Named("Microchip Manufacturer")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.legos)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                       ...
                                                                                       ,A2($Santa$Model$Stackable.stack,
                                                                                       10,
                                                                                       $Santa$Model$Product.oil)]))($Santa$Common.Named("Lego Factory")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.rcCar)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                       ...
                                                                                       ,A2($Santa$Model$Stackable.stack,
                                                                                       10,
                                                                                       $Santa$Model$Product.oil)]))($Santa$Common.Named("RC Car Factory")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.computer)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                          ...
                                                                                          ,A2($Santa$Model$Stackable.stack,
                                                                                          30,
                                                                                          $Santa$Model$Product.oil)]))($Santa$Common.Named("PC Manufacturer")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.gameConsole)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                             ...
                                                                                             ,A2($Santa$Model$Stackable.stack,
                                                                                             30,
                                                                                             $Santa$Model$Product.oil)]))($Santa$Common.Named("Game Console Manufacturer")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.wrappingPaper)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                               ...
                                                                                               ,A2($Santa$Model$Stackable.stack,
                                                                                               10,
                                                                                               $Santa$Model$Product.metal)]))($Santa$Common.Named("Paper Factory")($Basics.identity({_: {}}))));
   ...
   3,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Simple Toy Wrapper")($Basics.identity({_: {}}))));
   ...
   var highTechToyWrapper = Functional(_L.fromArray([A2(Transformer,
                                                    ...
                                                    $Santa$Model$Product.wrapped)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
   3,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("High-Tech Product Wrapper")($Basics.identity({_: {}}))));
   ...
   1,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Lumberjack")($Basics.identity({_: {}}))));
   ...
   1,
   $Santa$Model$Product.spirit)]))($Santa$Common.Named("Miner")($Basics.identity({_: {}}))));
   ...
   $Santa$Model$Product.oil)]))]))($Santa$Model$Purchasable.Purchasable(_L.fromArray([A2($Santa$Model$Stackable.stack,
                                                                                     ...
                                                                                     ,A2($Santa$Model$Stackable.stack,
                                                                                     1,
                                                                                     $Santa$Model$Product.spirit)]))($Santa$Common.Named("Oil Rig")($Basics.identity({_: {}}))));
...
Elm.Santa.Model.Product.make = function (_elm) {
   ...
   var wrappable = {_: {}
                   ,wrappable: true
                   ,wrapped: false};
   var woodenToy = $Santa$Common.Named("Wooden Toy")(wrappable);
   var metalCar = $Santa$Common.Named("Toy Car")(wrappable);
   var legos = $Santa$Common.Named("Lego Set")(wrappable);
   ...
   var consumable = {_: {}
                    ,wrappable: false
                    ,wrapped: false};
   var wrapped = $Santa$Common.Named("Wrapped Present")(_U.replace([["wrapped"
                                                                    ,true]],
   consumable));
   ...
   var basics = _L.fromArray([wood
                             ,metal
                             ,oil]);
   var wrappingPaper = $Santa$Common.Named("Wrapping Paper")(consumable);
   var battery = $Santa$Common.Named("Battery")(consumable);
   var plastic = $Santa$Common.Named("Plastic")(consumable);
   ...
   var description = function (bonuses) {
      return function () {
         ...
         _L.fromArray([{ctor: "_Tuple2"
                       ...
                       ,_1: function (x) {
                          return A2($Basics._op["++"],
                          "Increases resources gained from clicking by ",
                          A2($Basics._op["++"],
                          formatPct(x),
                          "."));
                       }}
                      ,{ctor: "_Tuple2"
                       ...
                       ,_1: function (x) {
                          return A2($Basics._op["++"],
                          "Increases the amount of spirits gained from deliveries by ",
                          A2($Basics._op["++"],
                          formatPct(x),
                          "."));
                       }}
